...
MIDL_INTERFACE("51E05736-6AFF-44A8-9745-77605C99E8F2") IFW1TextGeometry : public IFW1Object {
	...
	virtual FW1_GLYPHVERTEX* STDMETHODCALLTYPE GetVerticeVector(
	) = 0;
};
...
MIDL_INTERFACE("83347A5C-B0B1-460e-A35C-427E8B85F9F4") IFW1FontWrapper : public IFW1Object {
	...
	virtual void STDMETHODCALLTYPE SetShader(__in ID3D11DeviceContext *pContext, __in UINT Flags) = 0;

	virtual void STDMETHODCALLTYPE SetDynamic(__in bool check) = 0;
