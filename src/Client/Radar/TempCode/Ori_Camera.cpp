...
{
	m_xmf4x4Projection = Radar::Math::PerspectiveFovLH(XMConvertToRadians(fFOVAngle), fAspectRatio, fNearPlaneDistance, fFarPlaneDistance);
...
{
	m_xmf4x4View = Radar::Math::LookAtLH(xmf3Position, xmf3LookAt, xmf3Up);
}
