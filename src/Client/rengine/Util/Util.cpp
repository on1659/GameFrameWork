...
void Util::Global_CreateConstBuffers()
{
	...
	UINT ncbElementBytes = ((sizeof(VS_CB_WORLD_MATRIX) + 255) & ~255); //256�� ���
	Util::gCbWorldMatrix =
	...
	ncbElementBytes = ((sizeof(XMFLOAT4) + 255) & ~255); //256�� ���
...
std::vector<uint8_t> Util::ReadCSOFile(const LPCTSTR& path)
{
